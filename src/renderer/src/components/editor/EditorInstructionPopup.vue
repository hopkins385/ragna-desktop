...
<template>
  <div class="absolute left-0 top-20 z-10 w-full grow px-10" :style="{
    height: 'calc(100vh - 14rem)'
  }">
    <div ref="popupRef" class="relative flex h-full flex-col rounded-lg border bg-white p-5 shadow-md"
      @keydown="onKeyDown">
      ...
      <div class="relative my-3">
        <input ref="inputRef" type="text" name="instruction" placeholder="Write about..."
