...
<template>
  <DropdownMenu>
    ...
    <DropdownMenuContent class="relative w-52 p-2">
      ...
      <DropdownMenuItem class="p-2">
        <EditorButtonBox :active="false" @click="() => $emit('spellingGrammarClick')">
      ...
      <DropdownMenuSub>
        ...
        <DropdownMenuPortal>
          <DropdownMenuSubContent>
            <DropdownMenuItem>
              <EditorButtonBox :active="false" @click="() => $emit('translateClick', 'en')">
                <span>English</span>
              </EditorButtonBox>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <EditorButtonBox :active="false" @click="() => $emit('translateClick', 'es')">
                <span>Spanish</span>
              </EditorButtonBox>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <EditorButtonBox :active="false" @click="() => $emit('translateClick', 'fr')">
                <span>French</span>
              </EditorButtonBox>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <EditorButtonBox :active="false" @click="() => $emit('translateClick', 'de')">
                <span>German</span>
              </EditorButtonBox>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <EditorButtonBox :active="false" @click="() => $emit('translateClick', 'it')">
                <span>Italian</span>
              </EditorButtonBox>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <EditorButtonBox :active="false" @click="() => $emit('translateClick', 'nl')">
                <span>Dutch</span>
              </EditorButtonBox>
            </DropdownMenuItem>
          </DropdownMenuSubContent>
